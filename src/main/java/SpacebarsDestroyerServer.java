...
/**
 * Server for removing spacebars from a string.
 *
 * @author Stanislav Rakitov
 */
public class SpacebarsDestroyerServer implements Runnable {
  private final String serverAddress;
  private final int port;

  public SpacebarsDestroyerServer(String serverAddress, int port) {
